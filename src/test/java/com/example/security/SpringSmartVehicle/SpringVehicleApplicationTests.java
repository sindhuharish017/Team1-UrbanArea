...
*/
	...
	public void testCreateDl() {
		...
		DrivingLicense dl = new DrivingLicense(58,"ka06 12345671902", "Vaikumar", d, "Vumkur", fd, td, 76930991135L, str);
	...
	public void testLoginvalidator() throws Exception {
		...
		assertEquals(1, adminserviceimpl.loginValidator("admin"));
...
/*  @Test
	public void testGetbyId() {
		...
		drivingLicense.setId(1);
		drivingLicense.setDlno("KA yhjdgfcyhdsdf");
