...
body {
	...
	background-image:
		url(https://live.staticflickr.com/4738/25126612978_8deceae368_b.jpg);
...
label {
	...
	z-index: 1000;
	font-family: 'Bangers', cursive;
	text-shadow: 5px 5px 0 rgba(199, 190, 190, 0.7); @ include skew(0,
	-6.7deg, false); @ include transition-property(font-size); @ include
	transition-duration(0.5s);
	margin-bottom: 80px;
}
		...
		<form action="/vehicleType/${id}" method="post">
			...
			<div class="loginbox">
				...
				<div class="inputWithIcon">
					...
					<select id="vehicleList" name="vehicleType"
