...
import com.example.security.SpringSmartVehicle.Service.OtpService;
...
import com.example.security.SpringSmartVehicle.entity.User;
	...
	public class otpController {
	    ...
	    public void smsSubmit(@RequestBody User user) {
	        try{
	            service.send(user);
	        }
	        catch(Exception e){
	        ...
	        webSocket.convertAndSend(TOPIC_DESTINATION, getTimeStamp() + ": SMS has been sent!: "+user.getMobNumber());
